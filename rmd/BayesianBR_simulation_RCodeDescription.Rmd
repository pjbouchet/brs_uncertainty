...
#'--------------------------------------------------------------------
source('../R/BayesianBR_simulation_functions.R')
```
...
```{r echo=FALSE}
text_tbl <- data.frame(
  Argument = c("mcmc.object","layout.ncol", "pars.to.plot", "select.n", "select.obs", "summary.method", "start.shade", "n.cols", "darken.bars", "pt.size", "save.to.disk", "output.format"),
  Description = c("List object containing simulation outputs, as returned by simulate_scenario().",
    ...
    "Size of points in the output forest plots. Defaults to 8.5.",
...
text_tbl <- data.frame(
  ...
  Description = c("List object containing simulation outputs, as returned by simulate_scenario().",
    ...
    "Logical. Whether to save the plots to disk. Defaults to FALSE.",
    "Output file type. Defaults to 'pdf'.",
    "Width of the output plot (in inches for PDF and pixels for other formats).",
    "Height of the output plot (in inches for PDF and pixels for other formats).",
